...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: () => fetch("https://visa-navigator-server-gamma.vercel.app/visas")

            },
            {
                path: "/my-application-visa",
                element: <PrivateRout><MyApplicationVisa></MyApplicationVisa></PrivateRout>,
                loader: () => fetch("https://visa-navigator-server-gamma.vercel.app/myApplication")
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://visa-navigator-server-gamma.vercel.app/visas/${params.id}`)
            }
            ,
            {
                path: "/users",
                element: <PrivateRout><Users></Users></PrivateRout>,
                loader: () => fetch("https://visa-navigator-server-gamma.vercel.app/users")
            },
            {
